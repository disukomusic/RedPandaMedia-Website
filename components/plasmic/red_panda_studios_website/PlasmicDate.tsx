...
export const PlasmicDate__ArgProps = new Array<ArgPropType>();
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicDate.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicDate.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
